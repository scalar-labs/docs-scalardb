...
You'll be using the same sample application as found in the [ScalarDB SQL (JDBC) Sample](../scalardb-samples/scalardb-sql-jdbc-sample/README.mdx).
...
For details about the sample application, see the [sample application for ScalarDB SQL (JDBC)](../scalardb-samples/scalardb-sql-jdbc-sample/README.mdx#sample-application).
