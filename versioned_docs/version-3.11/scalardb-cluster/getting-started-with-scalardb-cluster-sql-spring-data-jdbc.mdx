...
You'll be using the same sample application as found in the [Sample application of Spring Data JDBC for ScalarDB](../scalardb-samples/spring-data-sample/README.mdx).
...
For details about the sample application, see the [sample application for Spring Data JDBC for ScalarDB](../scalardb-samples/spring-data-sample/README.mdx#sample-application).
...
```shell
$ java -jar scalardb-cluster-sql-cli-3.11.2-all.jar --config scalardb-sql.properties --file schema.sql
```
