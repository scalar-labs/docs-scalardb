...
For details, see [ScalarDB Java API Guide](https://github.com/scalar-labs/scalardb/blob/master/docs/api-guide.mdx).
...
```shell
java -jar scalardb-cluster-schema-loader-3.10.3-all.jar --config <PATH_TO_CONFIG_FILE> -f <PATH_TO_SCHEMA_FILE> --coordinator
```
...
```gradle
dependencies {
    implementation 'com.scalar-labs:scalardb-sql-jdbc:3.10.3'
    implementation 'com.scalar-labs:scalardb-cluster-client:3.10.3'
}
```
...
```gradle
dependencies {
    implementation 'com.scalar-labs:scalardb-sql-spring-data:3.10.3'
    implementation 'com.scalar-labs:scalardb-cluster-client:3.10.3'
}
```
...
```shell
java -jar scalardb-cluster-sql-cli-3.10.3-all.jar --config <PATH_TO_CONFIG_FILE>
```
