...
You can download the SQL CLI for Cluster from [ScalarDB Releases](https://github.com/scalar-labs/scalardb/releases/tag/v3.10.5). After downloading the JAR file, you can run the SQL CLI with the following command:
...
```console
java -jar scalardb-cluster-sql-cli-3.10.5-all.jar -h
