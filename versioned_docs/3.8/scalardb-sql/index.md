...
The library and the JDBC ScalarDB driver are available on [Packages in this repository](https://github.com/orgs/scalar-labs/packages?repo_name=scalardb-sql).
...
```gradle
dependencies {
    implementation 'com.scalar-labs:scalardb-sql:3.8.0'
}
```
...
```gradle
dependencies {
    implementation 'com.scalar-labs:scalardb-sql-jdbc:3.8.0'
}
```
...
- Javadoc
  ...
  - [scalardb-sql-spring-data](https://scalar-labs.github.io/scalardb-sql/javadoc/spring-data/index.html) - ScalarDB SQL Spring Data: Spring Data integration with ScalarDB
