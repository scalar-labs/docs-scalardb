...
services:
  ...
  scalardb-cluster-standalone:
    ...
    image: "ghcr.io/scalar-labs/scalardb-cluster-node-byol-premium:3.14.5"
    ports:
      - 60053:60053
      - 9080:9080
    volumes:
...
```console
java -jar scalardb-cluster-sql-cli-3.14.5-all.jar --config scalardb-cluster-sql-cli.properties
```
