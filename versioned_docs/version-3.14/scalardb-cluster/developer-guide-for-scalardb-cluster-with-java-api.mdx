...
```console
java -jar scalardb-cluster-schema-loader-3.14.3-all.jar --config <PATH_TO_CONFIG_FILE> -f <PATH_TO_SCHEMA_FILE> --coordinator
```
...
```console
java -jar scalardb-cluster-sql-cli-3.14.3-all.jar --config <PATH_TO_CONFIG_FILE>
```
