...
The `CREATE ABAC_POLICY` command creates a new ABAC policy with the specified policy name and data tag column name. The newly added policy is enabled by default.
...
- If you don't specify the data tag column name, the default data tag column name will be `<POLICY_NAME>_data_tag`.

#### Examples

Examples of `CREATE ABAC_POLICY` are as follows:
...
Examples of building statement objects for `CREATE ABAC_POLICY` are as follows:
...
The `ENABLE ABAC_POLICY` command enables the specified ABAC policy.
...
An example of `ENABLE ABAC_POLICY` is as follows:
...
An example of building statement objects for `ENABLE ABAC_POLICY` is as follows:
...
The `DISABLE ABAC_POLICY` command disables the specified ABAC policy. This command effectively disables ABAC functionality for all namespaces and tables associated with the specified policy.
...
An example of `DISABLE ABAC_POLICY` is as follows:
...
An example of building statement objects for `DISABLE ABAC_POLICY` is as follows:
...
The `CREATE ABAC_LEVEL` command creates a new ABAC level with the specified level short name, long name, and level number in the specified policy.
...
An example of `CREATE ABAC_LEVEL` are as follows:
...
An example of building statement objects for `CREATE ABAC_LEVEL` are as follows:
...
The `DROP ABAC_LEVEL` command drops the specified ABAC level in the specified policy.
...
An example of `DROP ABAC_LEVEL` is as follows:
...
An example of building statement objects for `DROP ABAC_LEVEL` is as follows:
...
The `CREATE ABAC_COMPARTMENT` command creates a new ABAC compartment with the specified compartment short name and long name in the specified policy.
...
An example of `CREATE ABAC_COMPARTMENT` are as follows:
...
An example of building statement objects for `CREATE ABAC_COMPARTMENT` are as follows:
...
The `DROP ABAC_COMPARTMENT` command drops the specified ABAC compartment in the specified policy.
...
An example of `DROP ABAC_COMPARTMENT` is as follows:
...
An example of building statement objects for `DROP ABAC_COMPARTMENT` is as follows:
...
The `CREATE ABAC_GROUP` command creates a new ABAC group with the specified short name, long name, and optionally a parent group, within the specified policy.
...
Examples of `CREATE ABAC_GROUP` are as follows:
...
Examples of building statement objects for `CREATE ABAC_GROUP` are as follows:
...
The `DROP ABAC_GROUP` command drops the specified ABAC group in the specified policy.
...
An example of `DROP ABAC_GROUP` is as follows:
...
An example of building statement objects for `DROP ABAC_GROUP` is as follows:
...
The `SET ABAC_LEVEL` command sets the specified ABAC levels for the specified user in the specified policy.
...
- If you omit the default level, the level specified by `<LEVEL_SHORT_NAME>` will be used as the default level.
- If you omit the row level, the default level will be used as the row level.

#### Examples

Examples of `SET ABAC_LEVEL` are as follows:
...
Examples of building statement objects for `SET ABAC_LEVEL` are as follows:
...
The `ADD ABAC_COMPARTMENT` command adds the specified ABAC compartment to the specified user in the specified policy.
...
- If you omit the access mode, the default access mode will be `READ_ONLY_ACCESS`.
...
- If you omit the boolean literal for `default` or `row`, the value of `default` or `row` will be set to `TRUE`.

#### Examples

Examples of `ADD ABAC_COMPARTMENT` are as follows:
...
Examples of building statement objects for `ADD ABAC_COMPARTMENT` are as follows:
...
The `REMOVE ABAC_COMPARTMENT` command removes the specified compartment from the specified user in the specified policy.
...
An example of `REMOVE ABAC_COMPARTMENT` is as follows:
...
An example of building statement objects for `REMOVE ABAC_COMPARTMENT` is as follows:
...
The `ADD ABAC_GROUP` command adds the specified ABAC group to the specified user in the specified policy.
...
Examples of `ADD ABAC_GROUP` are as follows:
...
Examples of building statement objects for `ADD ABAC_GROUP_TO_USER` are as follows:
...
The `REMOVE ABAC_GROUP` command removes the specified ABAC group from the specified user in the specified policy.
...
An example of `REMOVE ABAC_GROUP` is as follows:
...
An example of building statement objects for `REMOVE ABAC_GROUP` is as follows:
...
The `DROP ABAC_USER_TAG_INFO` command drops the specified ABAC user tag information from the specified user in the specified policy.
...
An example of `DROP ABAC_USER_TAG_INFO` is as follows:
...
An example of building statement objects for `DROP ABAC_USER_TAG_INFO` is as follows:
...
The `CREATE ABAC_NAMESPACE_POLICY` command creates a new ABAC namespace policy, with the specified namespace policy name using the specified policy and namespace. This command is used to apply the policy to the specified namespace. The newly added namespace policy is enabled by default.
...
An example of `CREATE ABAC_NAMESPACE_POLICY` is as follows:
...
An example of building statement objects for `CREATE ABAC_NAMESPACE_POLICY` is as follows:
...
The `ENABLE ABAC_NAMESPACE_POLICY` command enables the specified ABAC namespace policy.
...
An example of `ENABLE ABAC_NAMESPACE_POLICY` is as follows:
...
An example of building statement objects for `ENABLE ABAC_NAMESPACE_POLICY` is as follows:
...
The `DISABLE ABAC_NAMESPACE_POLICY` command disables the specified ABAC namespace policy. This command effectively disables ABAC functionality for the namespace associated with the specified namespace policy.
...
An example of `DISABLE ABAC_NAMESPACE_POLICY` is as follows:
...
An example of building statement objects for `DISABLE ABAC_NAMESPACE_POLICY` is as follows:
...
The `CREATE ABAC_TABLE_POLICY` command creates a new ABAC table policy, with the specified table policy name using the specified policy and table. This command is used to apply the policy to the specified table. The newly added table policy is enabled by default.
...
An example of `CREATE ABAC_TABLE_POLICY` is as follows:
...
An example of building statement objects for `CREATE ABAC_TABLE_POLICY` is as follows:
...
The `ENABLE ABAC_TABLE_POLICY` command enables the specified ABAC table policy.
...
An example of `ENABLE ABAC_TABLE_POLICY` is as follows:
...
An example of building statement objects for `ENABLE ABAC_TABLE_POLICY` is as follows:
...
The `DISABLE ABAC_TABLE_POLICY` command disables the specified ABAC table policy. This command effectively disables ABAC functionality for the table associated with the specified table policy.
...
An example of `DISABLE ABAC_TABLE_POLICY` is as follows:
...
An example of building statement objects for `DISABLE ABAC_TABLE_POLICY` is as follows:
...
The `SHOW ABAC_POLICY` command shows the specified ABAC policy.

This command returns the following columns:

- `name`: `TEXT` - the policy name
- `dataTagColumnName`: `TEXT` - the data tag column name
- `state`: `TEXT` - the state of the policy (either `ENABLED` or `DISABLED`)
...
An example of `SHOW ABAC_POLICY` is as follows:
...
An example of building statement objects for `SHOW ABAC_POLICY` is as follows:
...
The `SHOW ABAC_POLICIES` command shows all ABAC policies.
...
An example of `SHOW ABAC_POLICIES` is as follows:
...
An example of building statement objects for `SHOW ABAC_POLICIES` is as follows:
...
The `SHOW ABAC_LEVEL` command shows the specified ABAC level in the specified policy.

This command returns the following columns:

- `policyName`: `TEXT` - the policy name
- `shortName`: `TEXT` - the short name of the level
- `longName`: `TEXT` - the long name of the level
- `levelNumber`: `INTEGER` - the level number of the level
...
An example of `SHOW ABAC_LEVEL` is as follows:
...
An example of building statement objects for `SHOW ABAC_LEVEL` is as follows:
...
The `SHOW ABAC_LEVELS` command shows all ABAC levels in the specified policy.
...
An example of `SHOW ABAC_LEVELS` is as follows:
...
An example of building statement objects for `SHOW ABAC_LEVELS` is as follows:
...
The `SHOW ABAC_COMPARTMENT` command shows the specified ABAC compartment in the specified policy.

This command returns the following columns:

- `policyName`: `TEXT` - the policy name
- `shortName`: `TEXT` - the short name of the compartment
- `longName`: `TEXT` - the long name of the compartment
...
An example of `SHOW ABAC_COMPARTMENT` is as follows:
...
An example of building statement objects for `SHOW ABAC_COMPARTMENT` is as follows:
...
The `SHOW ABAC_COMPARTMENTS` command shows all ABAC compartments in the specified policy.
...
An example of `SHOW ABAC_COMPARTMENTS` is as follows:
...
An example of building statement objects for `SHOW ABAC_COMPARTMENTS` is as follows:
...
The `SHOW ABAC_GROUP` command shows the specified ABAC group in the specified policy.

This command returns the following columns:

- `policyName`: `TEXT` - the policy name
- `shortName`: `TEXT` - the short name of the group
- `longName`: `TEXT` - the long name of the group
- `parentGroupShortName`: `TEXT` - the short name of the parent group. If the group has no parent group, this column will be `null`
...
An example of `SHOW ABAC_GROUP` is as follows:
...
An example of building statement objects for `SHOW ABAC_GROUP` is as follows:
...
The `SHOW ABAC_GROUPS` command shows all ABAC groups in the specified policy.
...
An example of `SHOW ABAC_GROUPS` is as follows:
...
An example of building statement objects for `SHOW ABAC_GROUPS` is as follows:
...
The `SHOW ABAC_USER_TAG_INFO` command shows the ABAC user tag information for the specified user in the specified policy.

This command returns the following columns:

- `policyName`: `TEXT` - the policy name
- `username`: `TEXT` - the username
- `readTag`: `TEXT` - the read tag
- `writeTag`: `TEXT` - the write tag
- `defaultReadTag`: `TEXT` - the default read tag
- `defaultWriteTag`: `TEXT` - the default write tag
- `rowTag`: `TEXT` - the row tag
...
Examples of `SHOW ABAC_USER_TAG_INFO` are as follows:
...
Examples of building statement objects for `SHOW ABAC_USER_TAG_INFO` are as follows:
...
The `SHOW ABAC_NAMESPACE_POLICY` command shows the specified ABAC namespace policy.

This command returns the following columns:

- `name`: `TEXT` - the name of the namespace policy
- `policyName`: `TEXT` - the policy name
- `namespaceName`: `TEXT` - the namespace name
- `state`: `TEXT` - the state of the policy (either `ENABLED` or `DISABLED`)
...
An example of `SHOW ABAC_NAMESPACE_POLICY` is as follows:
...
An example of building statement objects for `SHOW ABAC_NAMESPACE_POLICY` is as follows:
...
The `SHOW ABAC_NAMESPACE_POLICIES` command shows all ABAC namespace policies.
...
An example of `SHOW ABAC_NAMESPACE_POLICIES` is as follows:
...
An example of building statement objects for `SHOW ABAC_NAMESPACE_POLICIES` is as follows:
...
The `SHOW ABAC_TABLE_POLICY` command shows the specified ABAC table policy.

This command returns the following columns:

- `name`: `TEXT` - the name of the table policy
- `policyName`: `TEXT` - the policy name
- `namespaceName`: `TEXT` - the namespace name
- `tableName`: `TEXT` - the table name
- `state`: `TEXT` - the state of the policy (either `ENABLED` or `DISABLED`)
...
An example of `SHOW ABAC_TABLE_POLICY` is as follows:
...
An example of building statement objects for `SHOW ABAC_TABLE_POLICY` is as follows:
...
The `SHOW ABAC_TABLE_POLICIES` command shows all ABAC table policies.
...
An example of `SHOW ABAC_TABLE_POLICIES` is as follows:
...
An example of building statement objects for `SHOW ABAC_TABLE_POLICIES` is as follows:
