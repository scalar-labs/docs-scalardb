...
services:
  scalardb-cluster-standalone:
    ...
    image: "ghcr.io/scalar-labs/scalardb-cluster-node-byol-premium:3.15.6"
    ports:
      - 60053:60053
      - 9080:9080
    volumes:
...
<Tabs groupId="build_tools" queryString>
  <TabItem value="gradle" label="Gradle" default>
    ...
    ```gradle
    dependencies {
      implementation 'com.scalar-labs:scalardb-cluster-embedding-java-client-sdk:3.15.6'
    }
    ```
  </TabItem>
...
- [Javadoc](https://javadoc.io/doc/com.scalar-labs/scalardb-cluster-embedding-java-client-sdk/3.15.6/index.html)
