...
```gradle
dependencies {
    implementation 'com.scalar-labs:scalardb-cluster-java-client-sdk:3.15.6'
}
```
...
You can download the Schema Loader for Cluster from [ScalarDB Releases](https://github.com/scalar-labs/scalardb/releases/tag/v3.15.6).
After downloading the JAR file, you can run Schema Loader for Cluster with the following command:

```console
java -jar scalardb-cluster-schema-loader-3.15.6-all.jar --config <PATH_TO_SCALARDB_PROPERTIES_FILE> --schema-file <PATH_TO_SCHEMA_FILE> --coordinator
```
...
```console
docker run --rm -v <PATH_TO_YOUR_LOCAL_SCALARDB_PROPERTIES_FILE>:/scalardb.properties -v <PATH_TO_YOUR_LOCAL_SCHEMA_FILE>:/schema.json ghcr.io/scalar-labs/scalardb-cluster-schema-loader:3.15.6 --config /scalardb.properties --schema-file /schema.json --coordinator
```
...
```gradle
dependencies {
    implementation 'com.scalar-labs:scalardb-sql-jdbc:3.15.6'
    implementation 'com.scalar-labs:scalardb-cluster-java-client-sdk:3.15.6'
}
```
...
```gradle
dependencies {
    implementation 'com.scalar-labs:scalardb-sql-spring-data:3.15.6'
    implementation 'com.scalar-labs:scalardb-cluster-java-client-sdk:3.15.6'
}
```
...
You can download the SQL CLI for Cluster from [ScalarDB Releases](https://github.com/scalar-labs/scalardb/releases/tag/v3.15.6). After downloading the JAR file, you can run the SQL CLI with the following command:

```console
java -jar scalardb-cluster-sql-cli-3.15.6-all.jar --config <PATH_TO_SCALARDB_SQL_PROPERTIES_FILE>
```
...
```console
docker run --rm -it -v <PATH_TO_YOUR_LOCAL_SCALARDB_SQL_PROPERTIES_FILE>:/scalardb-sql.properties ghcr.io/scalar-labs/scalardb-cluster-sql-cli:3.15.6 --config /scalardb-sql.properties
```
...
```console
java -jar scalardb-cluster-sql-cli-3.15.6-all.jar -h
...
* [ScalarDB Cluster Java Client SDK](https://javadoc.io/doc/com.scalar-labs/scalardb-cluster-java-client-sdk/3.15.6/index.html)
* [ScalarDB Cluster Common](https://javadoc.io/doc/com.scalar-labs/scalardb-cluster-common/3.15.6/index.html)
* [ScalarDB Cluster RPC](https://javadoc.io/doc/com.scalar-labs/scalardb-cluster-rpc/3.15.6/index.html)
