...
called [Two-phase Commit Transactions](../two-phase-commit-transactions.mdx).
...
the [exception handling guide for ScalarDB two-phase commit transaction](../two-phase-commit-transactions.mdx#handle-exceptions).
