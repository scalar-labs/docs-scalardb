...
For details about configurations for the transaction manager, see [Transaction manager configurations](../configurations.mdx#transaction-manager-configurations).
...
In addition to the configurations described in [Transaction manager configurations](../configurations.mdx#transaction-manager-configurations) and [Other configurations](../configurations.mdx#other-configurations), the following configurations are available for ScalarDB SQL Server:
