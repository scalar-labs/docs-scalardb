...
- Do you have a fully privileged account that can manage the target database? For details, see [Privileges to access the underlying databases](../requirements.mdx#privileges-to-access-the-underlying-databases).
