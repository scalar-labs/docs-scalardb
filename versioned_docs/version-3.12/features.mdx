...
| [Vector search interface](https://scalardb.scalar-labs.com/docs/latest/scalardb-cluster/getting-started-with-vector-search/)                                           |                          |                                        | :heavy_check_mark: (3.15+)                  |                                 |
| [Analytical query processing across ScalarDB-managed data sources](scalardb-samples/scalardb-analytics-spark-sample.mdx)     | ❌                         | ❌                                       | ❌                                            | ✅ (3.14+)      |
| [Vector search interface](scalardb-cluster/getting-started-with-vector-search.mdx)                                           |                          |                                        | :heavy_check_mark: (3.15+)                  |                                 |
