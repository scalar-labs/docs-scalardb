...
Please see [Getting Started with ScalarDB](../getting-started-with-scalardb.mdx) for the details of the underlining storage/database configurations.
...
Please see [ScalarDB server](../scalardb-server.mdx) for the details of configurations of ScalarDB Server.
