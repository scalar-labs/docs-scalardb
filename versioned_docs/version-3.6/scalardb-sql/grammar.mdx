...
Please see [ScalarDB Java API Guide - Creation Options](../api-guide.mdx#creation-options) for the details of Creation Options.
...
Please see [ScalarDB design document - Data Model](../design.mdx#data-model) for the details of the ScalarDB Data Model.
...
Please see also [Java API Guide - Get operation](../api-guide.mdx#get-operation) and [Scan operation](../api-guide.mdx#scan-operation) for more details of retrieving data from the database in ScalarDB
