...
For using the native ScalarDB library, please refer to [Getting Started](../../getting-started-with-scalardb.mdx).
More information about ScalarDB Server can be found [here](../../scalardb-server.mdx).
...
The configuration of ScalarDB Server is shown below. (It is also stored in [database.properties](https://github.com/scalar-labs/scalardb-samples/tree/master/scalardb-server-sample/database.properties))
```properties
...
```
*For using other databases as the backend for ScalarDB Server, we can change the configuration of [database.properties](https://github.com/scalar-labs/scalardb-samples/tree/master/scalardb-server-sample/database.properties) according to [Getting Started with ScalarDB](../../getting-started-with-scalardb.mdx). After that we can start ScalarDB Server using [docker-compose.yml](https://github.com/scalar-labs/scalardb-samples/tree/master/scalardb-server-sample/docker-compose.yml) instead.*
...
But, in this case, you need to specify the server as a contact point and `grpc` for the storage and transaction_manager configuration as follows. (it is stored in [scalardb-client.properties](https://github.com/scalar-labs/scalardb-samples/tree/master/scalardb-server-sample/scalardb-client.properties)).
```properties
# Comma separated contact points
...
Now you apply the database schema of the sample application as shown below. (It is stored in [emoney.json](https://github.com/scalar-labs/scalardb-samples/tree/master/scalardb-server-sample/emoney.json)).
```json
{
  "emoney.account": {
    "transaction": true,
...
## Storage abstraction
ScalarDB Server also supports [Storage API](../../storage-abstraction.mdx).
...
You can create a schema by setting `transaction` to false. (The updated schema is stored in [emoney-storage.json](https://github.com/scalar-labs/scalardb-samples/tree/master/scalardb-server-sample/emoney-storage.json))
```json
{
  "emoney.account": {
    "transaction": false,
