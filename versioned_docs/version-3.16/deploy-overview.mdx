...
## Deploy ScalarDB Analytics in a local Kubernetes environment

To learn how to deploy ScalarDB Analytics in a local Kubernetes environment by using a Helm Chart, see [Deploy ScalarDB Analytics Locally](scalardb-analytics/deployment-local.mdx).
