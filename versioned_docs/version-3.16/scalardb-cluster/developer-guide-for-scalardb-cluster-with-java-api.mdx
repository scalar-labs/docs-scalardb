...
You can download the ScalarDB Cluster Schema Loader from [ScalarDB Releases](https://github.com/scalar-labs/scalardb/releases/tag/v3.16.6) and run it as follows:
...
You can download the ScalarDB Cluster SQL CLI from [ScalarDB Releases](https://github.com/scalar-labs/scalardb/releases/tag/v3.16.6) and run it as follows:
