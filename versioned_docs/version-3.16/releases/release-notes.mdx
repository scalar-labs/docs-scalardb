...
This release improves Cosmos DB error handling and thread pool management for two-phase commit transactions in ScalarDB SQL, and upgrades the AWS SDK and grpc_health_probe to address security vulnerabilities.
