...
<Tabs groupId="databases" queryString>
  <TabItem value="Amazon_RDS_or_Azure_Database_for_MySQL_or_PostgreSQL" label="Amazon RDS or Azure Database for MySQL or PostgreSQL">
...
<Tabs groupId="databases" queryString>
  ...
  <TabItem value="DynamoDB" label="DynamoDB">
    You must enable the PITR feature for DynamoDB tables. If you're using [ScalarDB Schema Loader](schema-loader/README.mdx) to create schemas, the tool enables the PITR feature for tables by default.
