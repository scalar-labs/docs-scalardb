...
We have Docker images in [our repository](https://github.com/orgs/scalar-labs/packages) and zip archives of ScalarDB Server available in [releases](https://github.com/scalar-labs/scalardb/releases).
...
It contains two sections, Server configurations and Underlying storage/database configurations.
