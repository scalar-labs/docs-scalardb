...
<Tabs groupId="databases" queryString>
  <TabItem value="MySQL_MariaDB_TiDB" label="MySQL, MariaDB, and TiDB" default>
  ...
  <TabItem value="PostgreSQL_YugabyteDB_AlloyDB" label="PostgreSQL, YugabyteDB, and AlloyDB">
...
For details about transaction metadata decoupling, see [Transaction metadata decoupling](./schema-loader.mdx#transaction-metadata-decoupling).
