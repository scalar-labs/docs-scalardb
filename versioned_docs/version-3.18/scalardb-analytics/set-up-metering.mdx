...
- A ScalarDB Analytics server. For instructions on setting up a server, see [Create a ScalarDB Analytics Catalog](./create-scalardb-analytics-catalog.mdx).
- A Spark environment configured to run analytical queries. For instructions, see [Run Analytical Queries Through ScalarDB Analytics](./run-analytical-queries.mdx).
...
For the complete list of server properties, including the metadata database, TLS, and license settings, see [ScalarDB Analytics Configurations](./configurations.mdx). After updating the configuration, restart the ScalarDB Analytics server so that the new storage settings take effect.
...
- [Create a ScalarDB Analytics Catalog](./create-scalardb-analytics-catalog.mdx)
- [Run Analytical Queries Through ScalarDB Analytics](./run-analytical-queries.mdx)
- [ScalarDB Analytics Configurations](./configurations.mdx)
