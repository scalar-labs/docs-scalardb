...
This release adds support for the AWS Advanced JDBC Wrapper for fast Aurora failover, improves Cosmos DB error handling and ScalarDB Cluster's attribute-based access control metadata cache refresh, adds retry handling for conflict errors during schema operations, and upgrades the AWS SDK and grpc_health_probe to address security vulnerabilities.
...
- Upgraded the AWS SDK to fix security issues: [CVE-2026-54399](https://github.com/advisories/GHSA-hf6x-8p5f-cgmf "CVE-2026-54399") and [CVE-2026-54428](https://github.com/advisories/GHSA-v3jc-474w-2wm6 "CVE-2026-54428") ([#3838](https://github.com/scalar-labs/scalardb/pull/3838))
