...
<Tabs groupId="databases" queryString>
  ...
  <TabItem value="Spanner" label="Spanner">
    ...
    `scalardb-samples/scalardb-kotlin-sample` ディレクトリの `docker-compose.yml` ファイルを使用して、Docker Compose で Spanner Omni を実行できます。
    ...
    `scalardb-samples/scalardb-kotlin-sample` ディレクトリの **database.properties** ファイルには、ScalarDB のデータベース設定が含まれています。**database.properties** ファイル内の Spanner のプロパティのコメントを解除して、設定が次のようになるようにしてください。
