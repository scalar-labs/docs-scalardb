...
JDBC における 2PC インターフェースのサポートは ScalarDB 3.19 以降、非推奨となり、将来のリリースで削除される予定です。したがって、追加のドキュメントは予定されていません。
...
Java における 2PC インターフェースのサポートは ScalarDB 3.19 以降、非推奨となり、将来のリリースで削除される予定です。したがって、追加のドキュメントは予定されていません。
...
.NET (SQL) における 2PC インターフェースのサポートは ScalarDB 3.19 以降、非推奨となり、将来のリリースで削除される予定です。したがって、追加のドキュメントは予定されていません。
