...
|:--------------------------|:------------------------------------------|:------------------------------------------|
| 3.18                      | 3.12 - 3.18                              | 3.12* - 3.18                             |
| 3.17                      | 3.12 - 3.17                              | 3.12* - 3.17                             |
| 3.16                      | 3.12 - 3.16                              | 3.12* - 3.16                             |
| 3.15                      | 3.12 - 3.15                              | 3.12* - 3.15                             |
...
- ScalarDB Cluster とクライアント SDK の **メジャー** バージョンが同じで、**マイナー** バージョンが異なる場合、ScalarDB Cluster のバージョンはクライアント SDK バージョン以上である必要があります。例:
  - **サポート対象:** ScalarDB Cluster 3.17とクライアント SDK 3.14の組み合わせ
  - **サポート対象外:** ScalarDB Cluster 3.14とクライアント SDK 3.17の組み合わせ
- **メジャー** バージョンと **マイナー** バージョンが同じ場合、ScalarDB Cluster とクライアント SDK 間で異なる **パッチ** バージョンを使用できます。例:
  - **サポート対象:** ScalarDB Cluster 3.17.2とクライアント SDK 3.17.0の組み合わせ
  - **サポート対象:** ScalarDB Cluster 3.17.0とクライアント SDK 3.17.2の組み合わせ
