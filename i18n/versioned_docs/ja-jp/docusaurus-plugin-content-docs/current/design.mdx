...
| Cluster     | リモートレプリケーション管理テーブル (`transaction_groups`)                                            | [リモートレプリケーション](./scalardb-cluster/remote-replication.mdx)におけるプライマリサイトからの書き込み操作のバッファリング用 | レプリケーションデータベース内                                       |
| Cluster     | リモートレプリケーション管理テーブル (`__records` サフィックス付き)                                      | [リモートレプリケーション](./scalardb-cluster/remote-replication.mdx)におけるバックアップサイトデータベーステーブルのレプリケーション状態管理用 | バックアップサイトデータベース内                                     |
