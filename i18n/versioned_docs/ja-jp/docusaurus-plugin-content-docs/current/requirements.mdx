...
- 60053 (Administrative API / Transactional API / SQL API / 管理者サービス; `scalar.db.cluster.node.port` で設定可能)
...
- **[Red Hat OpenShift](https://www.redhat.com/ja/technologies/cloud-computing/openshift):** 4.18 - 4.21
