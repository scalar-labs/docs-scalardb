...
| [属性ベースのアクセス制御](scalardb-cluster/authorize-with-abac.mdx)                                                | –                         | –                                      | ✅ (3.15+) (Enterprise Premium Option*, Public Preview) | –                               |
...
| [リモートレプリケーション](scalardb-cluster/remote-replication.mdx)                                                 | –                         | –                                      | ✅ (3.16+) (Public Preview)                             | –                               |
