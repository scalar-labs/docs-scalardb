...
このサブカテゴリでは、ScalarDB Analytics というコンポーネントを使用して、ScalarDB で作成したデータベースに対して分析クエリを実行する方法に関するチュートリアルを参照できます。ScalarDB Analytics は、ScalarDB トランザクションを通じて更新される ScalarDB 管理データベースと、ScalarDB 管理以外のデータベースの両方を対象とします。
