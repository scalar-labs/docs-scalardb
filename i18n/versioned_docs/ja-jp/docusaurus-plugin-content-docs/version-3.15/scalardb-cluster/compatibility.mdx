...
- ScalarDB Cluster とクライアント SDK の **メジャー** バージョンが同じで、**マイナー** バージョンが異なる場合、ScalarDB Cluster のバージョンはクライアント SDK バージョン以上である必要があります。例:
  - **サポート対象:** ScalarDB Cluster 3.15とクライアント SDK 3.14の組み合わせ
  - **サポート対象外:** ScalarDB Cluster 3.14とクライアント SDK 3.15の組み合わせ
- **メジャー** バージョンと **マイナー** バージョンが同じ場合、ScalarDB Cluster とクライアント SDK 間で異なる **パッチ** バージョンを使用できます。例:
  - **サポート対象:** ScalarDB Cluster 3.15.9とクライアント SDK 3.15.0の組み合わせ
  - **サポート対象:** ScalarDB Cluster 3.15.0とクライアント SDK 3.15.9の組み合わせ
