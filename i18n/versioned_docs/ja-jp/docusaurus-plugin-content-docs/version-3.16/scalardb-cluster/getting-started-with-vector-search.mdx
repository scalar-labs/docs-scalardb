...
<Tabs groupId="build_tools" queryString>
  <TabItem value="gradle" label="Gradle" default>
    ...
    ```gradle
    dependencies {
      implementation 'com.scalar-labs:scalardb-cluster-embedding-java-client-sdk:3.16.3'
    }
    ```
  </TabItem>
...
- [Javadoc](https://javadoc.io/doc/com.scalar-labs/scalardb-cluster-embedding-java-client-sdk/3.16.3/index.html)
