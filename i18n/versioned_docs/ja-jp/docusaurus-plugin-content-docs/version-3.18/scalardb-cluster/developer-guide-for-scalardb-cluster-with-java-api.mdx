...
ScalarDB Cluster Schema Loader は [ScalarDB リリース](https://github.com/scalar-labs/scalardb/releases/tag/v3.18.1) からダウンロードし、次のように実行できます。
...
ScalarDB Cluster SQL CLI は、[ScalarDB リリース](https://github.com/scalar-labs/scalardb/releases/tag/v3.18.1) からダウンロードし、次のように実行できます。
