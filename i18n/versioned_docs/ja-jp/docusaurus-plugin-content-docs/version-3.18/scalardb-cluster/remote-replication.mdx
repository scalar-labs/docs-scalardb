...
### Private Preview の制限事項

現在の Private Preview バージョンには以下の制限がありますが、Public Preview または一般提供 (GA) 時には緩和される予定です:
...
リモートレプリケーションは現在 Private Preview です。この機能とドキュメントは変更される可能性があります。詳細については、[お問い合わせ](https://www.scalar-labs.com/contact)いただくか、この機能が Public Preview または GA になるまでお待ちください。
