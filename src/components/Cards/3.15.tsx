        ...
        {categories.map((cat, i) => (
          <React.Fragment key={i}>
            ...
            {cat.links.map((link, j) => {
              // Check if this cell has multiple links defined in the categoryLinks property
              const categoryLinkCell = cat.categoryLinks && cat.categoryLinks.find(item => item.cell === j);
              ...
              if (categoryLinkCell) {
                ...
                // Empty cell
                return <div key={j} className="empty-cell"></div>;
              }
            })}
          </React.Fragment>
        ))}
