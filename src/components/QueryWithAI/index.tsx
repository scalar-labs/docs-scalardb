    ...
    <div className="chat-with-page-wrapper" ref={wrapperRef}>
      ...
      {isOpen && (
        <div className="chat-with-page-panel" role="menu" aria-label="Chat with page options">
          ...
          <div className="chat-with-page-section-label">Chat with AI</div>

          <div className="chat-with-page-chat-row">
            <button className="chat-with-page-chat-btn" role="menuitem" onClick={handleChatGPT} title="Chat in ChatGPT">
            ...
            <button className="chat-with-page-chat-btn" role="menuitem" onClick={handleClaude} title="Chat in Claude">
              <svg className="chat-with-page-chat-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <button className="chat-with-page-chat-btn" role="menuitem" onClick={handlePerplexity} title="Chat in Perplexity">
              <svg className="chat-with-page-chat-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
