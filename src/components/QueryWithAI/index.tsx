...
function getPageMarkdown(): string {
  ...
  // Remove elements that are not part of readable content
...
export default function QueryWithAI(): JSX.Element | null {
  ...
  return (
    <div className="query-with-ai-wrapper" ref={wrapperRef}>
      <button
        className="query-with-ai-trigger"
        onClick={handleToggle}
        aria-expanded={isOpen}
        aria-haspopup="true"
      >
        <svg
          className="query-with-ai-icon"
        ...
        Query with AI
        <svg
          className={`query-with-ai-chevron${isOpen ? ' open' : ''}`}
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
      ...
      {isOpen && (
        <div className="query-with-ai-dropdown" role="menu">
          <div className="query-with-ai-section-label">Chat with AI</div>

          <button className="query-with-ai-item" role="menuitem" onClick={handleChatGPT}>
            <svg className="query-with-ai-item-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <button className="query-with-ai-item" role="menuitem" onClick={handleClaude}>
            <svg className="query-with-ai-item-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <button className="query-with-ai-item" role="menuitem" onClick={handlePerplexity}>
            <svg className="query-with-ai-item-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <div className="query-with-ai-separator" role="separator" />

          <div className="query-with-ai-section-label">Copy content</div>

          <button className="query-with-ai-item" role="menuitem" onClick={handleCopyMarkdown}>
            <svg className="query-with-ai-item-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          <button className="query-with-ai-item" role="menuitem" onClick={handleCopyLlmsTxt}>
            <svg className="query-with-ai-item-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          <button className="query-with-ai-item" role="menuitem" onClick={handleCopyLlmsFullTxt}>
            <svg className="query-with-ai-item-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
              <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
              <polyline points="14 2 14 8 20 8" />
              <line x1="16" y1="13" x2="8" y2="13" />
