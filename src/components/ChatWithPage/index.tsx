...
export default function ChatWithPage(): JSX.Element | null {
  ...
  return (
    <div className="chat-with-page-wrapper" ref={wrapperRef}>
      ...
      {isOpen && (
        <div className="chat-with-page-panel" role="menu" aria-label="Chat with page options">
          ...
          <div className="chat-with-page-chat-row">
            <button className="chat-with-page-chat-btn" role="menuitem" onClick={handleChatGPT} title="Open in ChatGPT">
              ...
              <span>Open in<br />ChatGPT</span>
            </button>

            <button className="chat-with-page-chat-btn" role="menuitem" onClick={handleClaude} title="Open in Claude">
              <svg className="chat-with-page-chat-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              ...
              <span>Open in<br />Claude</span>
            </button>

            <button className="chat-with-page-chat-btn" role="menuitem" onClick={handlePerplexity} title="Open in Perplexity">
              <svg className="chat-with-page-chat-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              ...
              <span>Open in<br />Perplexity</span>
            </button>
          </div>
        </div>
      )}
      ...
      >
        ...
        <span className="chat-with-page-label">Chat with page</span>
      </button>
    </div>
  );
}
