...
export default function ChatWithPage(): JSX.Element | null {
  ...
  return (
    <div className="chat-with-page-wrapper" ref={wrapperRef}>
      ...
      {isOpen && (
        <div className="chat-with-page-panel" role="menu" aria-label={isJapanese ? 'ページとチャットのオプション' : 'Chat with page options'}>
          <div className="chat-with-page-panel-header">
            <span className="chat-with-page-panel-title">
              ...
              {isJapanese ? 'ページとチャット' : 'Chat with page'}
            </span>
            <button
          ...
          <div className="chat-with-page-chat-row">
            <button className="chat-with-page-chat-btn" role="menuitem" onClick={handleChatGPT} title={isJapanese ? 'ChatGPT で開く' : 'Open in ChatGPT'}>
              ...
              <span>{isJapanese ? <>ChatGPT で<br />開く</> : <>Open in<br />ChatGPT</>}</span>
            </button>

            <button className="chat-with-page-chat-btn" role="menuitem" onClick={handleClaude} title={isJapanese ? 'Claude で開く' : 'Open in Claude'}>
              <svg className="chat-with-page-chat-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              ...
              <span>{isJapanese ? <>Claude で<br />開く</> : <>Open in<br />Claude</>}</span>
            </button>

            <button className="chat-with-page-chat-btn" role="menuitem" onClick={handlePerplexity} title={isJapanese ? 'Perplexity で開く' : 'Open in Perplexity'}>
              <svg className="chat-with-page-chat-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              ...
              <span>{isJapanese ? <>Perplexity で<br />開く</> : <>Open in<br />Perplexity</>}</span>
            </button>
          </div>
        </div>
      )}
      ...
      >
        ...
        <span className="chat-with-page-label">{isJapanese ? 'ページとチャット' : 'Chat with page'}</span>
      </button>
    </div>
  );
}
