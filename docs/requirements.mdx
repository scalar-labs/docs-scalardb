...
- **[Red Hat OpenShift](https://www.redhat.com/en/technologies/cloud-computing/openshift)**: 4.18 - 4.20
...
- **[OpenJDK](https://openjdk.org/) ([Eclipse Temurin](https://adoptium.net/temurin/), [Amazon Corretto](https://aws.amazon.com/corretto/), or [Microsoft Build of OpenJDK](https://learn.microsoft.com/en-us/java/openjdk/)):** 8, 11, or 17 (LTS versions)

:::note

For reference, the following shows the relationship between Spark versions and supported Java runtime versions on major cloud services:
