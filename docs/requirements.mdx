...
<TabItem value="Spanner" label="Spanner (PostgreSQL dialect)">
...
If you deploy the [Transaction Coordinator](./scalardb-cluster/scalardb-cluster-configurations.mdx#transaction-coordinator-configurations), it requires the following ports to be accessible:
...
<JDKVersions versionNumbers="8, 11, or 17" />
