...
:::
  ...
  <TabItem value="S3" label="S3">
    If you used AWS Backup to create a backup of your bucket, follow [Restore S3 data using AWS Backup](https://docs.aws.amazon.com/aws-backup/latest/devguide/restoring-s3.html).
  </TabItem>
  <TabItem value="Blob_Storage" label="Blob Storage">
    If you used Azure Backup to create a backup of your container, follow [Restore Azure Blobs](https://learn.microsoft.com/en-us/azure/backup/blob-restore?tabs=operational-backup).
  </TabItem>
  <TabItem value="Cloud_Storage" label="Cloud Storage">
