...
<Tabs groupId="databases" queryString>
  ...
  <TabItem value="Spanner" label="Spanner">
    ...
    The **database.properties** file in the `scalardb-samples/scalardb-kotlin-sample` directory contains database configurations for ScalarDB. Please uncomment the properties for Spanner in the **database.properties** file so that the configuration looks as follows:
