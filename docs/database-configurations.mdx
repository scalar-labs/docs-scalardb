...
<Tabs groupId="databases" queryString>
  ...
  <TabItem value="Object_Storage" label="Object Storage">
    ...
    - Use a single primary region for all operations.
      - There is no concept for primary regions in Object Storage, so you must designate a primary region by yourself.
    ...
    - Choose the following storage classes or access tiers for each storage:
      ...
      - **Blob Storage**: [Hot tier](https://learn.microsoft.com/en-us/azure/storage/blobs/access-tiers-overview)
...
:::
  ...
  <TabItem value="Object_Storage" label="Object Storage">
    - Since a ScalarDB partition maps to an object in Object Storage, it is recommended to design table schemas as follows:
