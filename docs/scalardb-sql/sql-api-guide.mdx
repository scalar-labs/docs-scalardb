...
For more details, see the <JavadocLink packageName="scalardb-sql" path="com/scalar/db/sql" className="PreparedStatement" />, <JavadocLink packageName="scalardb-sql" path="com/scalar/db/sql/statement" className="BoundStatement" />, and <JavadocLink packageName="scalardb-sql" path="com/scalar/db/sql/statement" className="SimpleStatement" /> pages of the Javadoc.
...
For more details, see the <JavadocLink packageName="scalardb-sql" path="com/scalar/db/sql" className="BatchedStatements" /> and <JavadocLink packageName="scalardb-sql" path="com/scalar/db/sql" className="SqlStatementExecutable" /> pages of the Javadoc.
...
In addition to `begin()`, `SqlSession` provides other variants, such as `beginReadOnly()` for starting a read-only transaction and overloads that accept transaction attributes. For details, see the <JavadocLink packageName="scalardb-sql" path="com/scalar/db/sql" className="SqlSession" /> page of the Javadoc.
