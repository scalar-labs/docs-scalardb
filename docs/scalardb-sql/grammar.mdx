...
- For details about `creation_options`, see [Creation options](../api-guide.mdx#creation-options-1).
...
- When using Consensus Commit, `CREATE INDEX` also creates a companion before-image secondary index. For details, see [Correctness of index-based reads](../consensus-commit.mdx#correctness-of-index-based-reads).
...
- For details about `creation_options`, see [Creation options](../api-guide.mdx#creation-options-2).
...
When using Consensus Commit, the companion before-image secondary index is also dropped. For details, see [Correctness of index-based reads](../consensus-commit.mdx#correctness-of-index-based-reads).
...
- You can specify transaction-scoped operation attributes by using the `WITH` clause. The specified attributes are merged into every operation issued within the transaction. For details on operation attributes, see [Operation attributes](../api-guide.mdx#operation-attributes).
