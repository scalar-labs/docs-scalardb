...
Then, delete the existing dependency for `com.scalar-labs:scalardb:3.9.1` from the `dependencies` section, and add the following dependency to the `dependencies` section:
...
You can download the Schema Loader for Cluster from [Releases](https://github.com/scalar-labs/scalardb-cluster/releases/tag/v3.9.1).
