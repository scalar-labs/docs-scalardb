...
```shell
java -jar scalardb-cluster-schema-loader-3.9.1-all.jar --config <PATH_TO_CONFIG_FILE> -f <PATH_TO_SCHEMA_FILE> --coordinator
```
...
```shell
java -jar scalardb-cluster-sql-cli-3.9.1-all.jar --config <PATH_TO_CONFIG_FILE>
```
