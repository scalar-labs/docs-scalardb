...
First, download the [`scalardb-cluster.proto`](https://github.com/scalar-labs/scalardb-cluster/blob/v3.9.2/rpc/src/main/proto/scalardb-cluster.proto) file, then save it in the working directory.
