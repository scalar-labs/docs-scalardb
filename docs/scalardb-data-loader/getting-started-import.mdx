...
| --log-put-value                 | Whether the value that was used in the ScalarDB `PUT` operation is included in the log files or not.<br />Optional and disabled by default.                                                                                                                                                                              | `scalardb-data-loader --log-put-value`                      |
