...
| [Attribute-based access control](scalardb-cluster/authorize-with-abac.mdx)                                                          | –                         | –                                      | ✅ (3.15+) (Enterprise Premium Option*, Public Preview) | –                               |
| [SQL interface (SQL API, JDBC, Spring Data JDBC, and LINQ)](scalardb-sql/index.mdx)                                                 | –                         | –                                      | ✅                                                         | –                               |
| [GraphQL interface](scalardb-graphql/index.mdx)                                                                                     | –                         | –                                      | ✅                                                         | –                               |
| [Vector search interface](scalardb-cluster/getting-started-with-vector-search.mdx)                                                  | –                         | –                                      | ✅ (3.15+) (Public Preview)                             | –                               |
...
| [Remote replication](scalardb-cluster/remote-replication.mdx)                                                                       | –                         | –                                      | ✅ (3.16+) (Public Preview)                             | –                               |
