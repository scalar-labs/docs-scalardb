...
For details about the sample application, see the [sample application for ScalarDB SQL (JDBC)](../scalardb-samples/tree/main/scalardb-sql-jdbc-sample/README.mdx#sample-application).
