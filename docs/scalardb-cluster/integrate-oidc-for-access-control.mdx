...
Set up Keycloak to issue JWT access tokens with the required claims. This step uses the Keycloak Admin REST API for reproducibility. First, set the following variables:
