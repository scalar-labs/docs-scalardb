...
Then, download the [`scalardb-cluster.proto`](https://github.com/scalar-labs/scalardb-cluster/blob/v3.12.0/rpc/src/main/proto/scalardb-cluster.proto) file and save it in the directory that you created.
